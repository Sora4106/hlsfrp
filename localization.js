(function () {
  ...
  const thaiByEnglish = {
    ...
    "Xiamen, China": "เซี่ยเหมิน ประเทศจีน",
    "Xiamen HaoLiXing Livestock Machinery Co., Ltd.": "บริษัท เซี่ยเหมิน เฮ่าลี่ซิง เครื่องจักรปศุสัตว์ จำกัด",
    "Hexiang West Road, Siming District, Xiamen": "ถนนเหอเสียงตะวันตก เขตซือหมิง เมืองเซี่ยเหมิน",
